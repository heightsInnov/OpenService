...
@XmlRootElement(name = "AMOUNTBLOCKSQUERY_IOFS_RES")
public class AMOUNTBLOCKSQUERYIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSQUERYIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSQUERYIOFSRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSQUERYIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSQUERYIOFSRES.FCUBSBODY value) {
