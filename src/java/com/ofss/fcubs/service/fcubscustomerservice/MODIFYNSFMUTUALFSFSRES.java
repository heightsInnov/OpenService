...
@XmlRootElement(name = "MODIFYNSFMUTUAL_FSFS_RES")
public class MODIFYNSFMUTUALFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYNSFMUTUALFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYNSFMUTUALFSFSRES.FCUBSBODY }
     *     
     */
    public MODIFYNSFMUTUALFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYNSFMUTUALFSFSRES.FCUBSBODY value) {
