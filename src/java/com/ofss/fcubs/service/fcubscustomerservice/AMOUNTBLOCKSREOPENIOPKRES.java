...
@XmlRootElement(name = "AMOUNTBLOCKSREOPEN_IOPK_RES")
public class AMOUNTBLOCKSREOPENIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSREOPENIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSREOPENIOPKRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSREOPENIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSREOPENIOPKRES.FCUBSBODY value) {
