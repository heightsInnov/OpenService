...
@XmlRootElement(name = "AMOUNTBLOCKSMODIFY_IOPK_RES")
public class AMOUNTBLOCKSMODIFYIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSMODIFYIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSMODIFYIOPKRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSMODIFYIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSMODIFYIOPKRES.FCUBSBODY value) {
