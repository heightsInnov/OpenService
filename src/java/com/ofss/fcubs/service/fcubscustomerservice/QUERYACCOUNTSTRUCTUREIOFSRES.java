 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Struct-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Structure-Query-IO-Type" minOccurs="0"/>
 *                   &lt;element name="Struct-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Structure-Full-Type" minOccurs="0"/>
...
@XmlRootElement(name = "QUERYACCOUNTSTRUCTURE_IOFS_RES")
public class QUERYACCOUNTSTRUCTUREIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYACCOUNTSTRUCTUREIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYACCOUNTSTRUCTUREIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYACCOUNTSTRUCTUREIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYACCOUNTSTRUCTUREIOFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Struct-IO")
        protected StructureQueryIOType structIO;
        @XmlElement(name = "Struct-Full")
        protected StructureFullType structFull;
        ...
        /**
         * Gets the value of the structIO property.
         * 
         * @return
         *     possible object is
         *     {@link StructureQueryIOType }
         *     
         */
        public StructureQueryIOType getStructIO() {
            return structIO;
        }

        /**
         * Sets the value of the structIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link StructureQueryIOType }
         *     
         */
        public void setStructIO(StructureQueryIOType value) {
            this.structIO = value;
        }

        /**
         * Gets the value of the structFull property.
         * 
         * @return
         *     possible object is
         *     {@link StructureFullType }
         *     
         */
        public StructureFullType getStructFull() {
            return structFull;
        }

        /**
         * Sets the value of the structFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link StructureFullType }
         *     
         */
        public void setStructFull(StructureFullType value) {
            this.structFull = value;
        }
