...
@XmlRootElement(name = "MODIFYACCOUNTSTRUCTURE_FSFS_RES")
public class MODIFYACCOUNTSTRUCTUREFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYACCOUNTSTRUCTUREFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYACCOUNTSTRUCTUREFSFSRES.FCUBSBODY }
     *     
     */
    public MODIFYACCOUNTSTRUCTUREFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYACCOUNTSTRUCTUREFSFSRES.FCUBSBODY value) {
