 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}TDAmountBlock-Reopen-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "REOPENTDAMOUNTBLOCK_IOPK_RES")
public class REOPENTDAMOUNTBLOCKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENTDAMOUNTBLOCKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENTDAMOUNTBLOCKIOPKRES.FCUBSBODY }
     *     
     */
    public REOPENTDAMOUNTBLOCKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENTDAMOUNTBLOCKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected TDAmountBlockReopenIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link TDAmountBlockReopenIOType }
         *     
         */
        public TDAmountBlockReopenIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(TDAmountBlockReopenIOType value) {
