...
@XmlRootElement(name = "DELETEAMTBLK_FSFS_REQ")
public class DELETEAMTBLKFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETEAMTBLKFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETEAMTBLKFSFSREQ.FCUBSBODY }
     *     
     */
    public DELETEAMTBLKFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETEAMTBLKFSFSREQ.FCUBSBODY value) {
