 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Customer-Modify-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "MODIFYCUSTOMER_IOPK_RES")
public class MODIFYCUSTOMERIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYCUSTOMERIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYCUSTOMERIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYCUSTOMERIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYCUSTOMERIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CustomerModifyIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link CustomerModifyIOType }
         *     
         */
        public CustomerModifyIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(CustomerModifyIOType value) {
