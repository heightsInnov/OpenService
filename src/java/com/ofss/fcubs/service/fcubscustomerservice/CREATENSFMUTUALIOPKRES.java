 ...
 *                   &lt;element name="MutClr-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Stdnsfms-Create-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CREATENSFMUTUAL_IOPK_RES")
public class CREATENSFMUTUALIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATENSFMUTUALIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATENSFMUTUALIOPKRES.FCUBSBODY }
     *     
     */
    public CREATENSFMUTUALIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATENSFMUTUALIOPKRES.FCUBSBODY value) {
