...
@XmlRootElement(name = "AUTHORIZECUSTSEGASSOCIATION_FSFS_RES")
public class AUTHORIZECUSTSEGASSOCIATIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY }
     *     
     */
    public AUTHORIZECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY value) {
