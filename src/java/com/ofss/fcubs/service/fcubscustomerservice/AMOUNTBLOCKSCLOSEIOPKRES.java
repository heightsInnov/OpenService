...
@XmlRootElement(name = "AMOUNTBLOCKSCLOSE_IOPK_RES")
public class AMOUNTBLOCKSCLOSEIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSCLOSEIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSCLOSEIOPKRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSCLOSEIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSCLOSEIOPKRES.FCUBSBODY value) {
