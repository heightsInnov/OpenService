...
@XmlRootElement(name = "CREATEAMTBLK_FSFS_RES")
public class CREATEAMTBLKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEAMTBLKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEAMTBLKFSFSRES.FCUBSBODY }
     *     
     */
    public CREATEAMTBLKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEAMTBLKFSFSRES.FCUBSBODY value) {
