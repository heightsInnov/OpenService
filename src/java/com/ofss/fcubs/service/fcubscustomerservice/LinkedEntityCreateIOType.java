...
/**
 * <p>Java class for LinkedEntity-Create-IO-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkedEntity-Create-IO-Type">
 *   &lt;complexContent>
...
@XmlType(name = "LinkedEntity-Create-IO-Type", propOrder = {
    "custno",
    "relationshipLinkage"
})
public class LinkedEntityCreateIOType {

    @XmlElement(name = "CUSTNO")
    protected String custno;
    @XmlElement(name = "Relationship-Linkage")
    protected List<LinkedEntityCreateIOType.RelationshipLinkage> relationshipLinkage;
     ...
     * {@link LinkedEntityCreateIOType.RelationshipLinkage }
     * 
     * 
     */
    public List<LinkedEntityCreateIOType.RelationshipLinkage> getRelationshipLinkage() {
        if (relationshipLinkage == null) {
            relationshipLinkage = new ArrayList<LinkedEntityCreateIOType.RelationshipLinkage>();
        }
