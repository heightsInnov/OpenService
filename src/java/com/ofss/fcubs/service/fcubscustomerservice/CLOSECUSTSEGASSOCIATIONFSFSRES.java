...
@XmlRootElement(name = "CLOSECUSTSEGASSOCIATION_FSFS_RES")
public class CLOSECUSTSEGASSOCIATIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY }
     *     
     */
    public CLOSECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY value) {
