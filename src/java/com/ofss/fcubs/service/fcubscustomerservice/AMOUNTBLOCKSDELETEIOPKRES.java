 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Amount-Blocks-PK" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AmountBlocks-PK-Type"/>
...
@XmlRootElement(name = "AMOUNTBLOCKSDELETE_IOPK_RES")
public class AMOUNTBLOCKSDELETEIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSDELETEIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSDELETEIOPKRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSDELETEIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSDELETEIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Amount-Blocks-PK", required = true)
