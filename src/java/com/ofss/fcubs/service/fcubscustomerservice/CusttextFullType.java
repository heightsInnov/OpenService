...
public class CusttextFullType {
    ...
    protected List<CusttextFullType.CUSTTEXT> custtext;
     ...
     * {@link CusttextFullType.CUSTTEXT }
     * 
     * 
     */
    public List<CusttextFullType.CUSTTEXT> getCUSTTEXT() {
        if (custtext == null) {
            custtext = new ArrayList<CusttextFullType.CUSTTEXT>();
        }
