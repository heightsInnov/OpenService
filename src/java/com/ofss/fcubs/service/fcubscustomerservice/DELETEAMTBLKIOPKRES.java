 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AmtBlk-Delete-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "DELETEAMTBLK_IOPK_RES")
public class DELETEAMTBLKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETEAMTBLKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETEAMTBLKIOPKRES.FCUBSBODY }
     *     
     */
    public DELETEAMTBLKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETEAMTBLKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected AmtBlkDeleteIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link AmtBlkDeleteIOType }
         *     
         */
        public AmtBlkDeleteIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(AmtBlkDeleteIOType value) {
