...
@XmlRootElement(name = "DELETECUSTOMER_FSFS_RES")
public class DELETECUSTOMERFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETECUSTOMERFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETECUSTOMERFSFSRES.FCUBSBODY }
     *     
     */
    public DELETECUSTOMERFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETECUSTOMERFSFSRES.FCUBSBODY value) {
