 ...
 *                   &lt;element name="Cust-Seg-Mapping-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustSegAssociation-Create-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CREATECUSTSEGASSOCIATION_IOPK_RES")
public class CREATECUSTSEGASSOCIATIONIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY }
     *     
     */
    public CREATECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY value) {
