...
@XmlRootElement(name = "CLOSEAMTBLK_FSFS_REQ")
public class CLOSEAMTBLKFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSEAMTBLKFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSEAMTBLKFSFSREQ.FCUBSBODY }
     *     
     */
    public CLOSEAMTBLKFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSEAMTBLKFSFSREQ.FCUBSBODY value) {
