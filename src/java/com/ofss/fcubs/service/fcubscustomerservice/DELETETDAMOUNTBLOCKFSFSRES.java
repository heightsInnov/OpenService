...
@XmlRootElement(name = "DELETETDAMOUNTBLOCK_FSFS_RES")
public class DELETETDAMOUNTBLOCKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETETDAMOUNTBLOCKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETETDAMOUNTBLOCKFSFSRES.FCUBSBODY }
     *     
     */
    public DELETETDAMOUNTBLOCKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETETDAMOUNTBLOCKFSFSRES.FCUBSBODY value) {
