 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Customer-Authorize-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "AUTHORIZECUSTOMER_IOPK_RES")
public class AUTHORIZECUSTOMERIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECUSTOMERIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECUSTOMERIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZECUSTOMERIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECUSTOMERIOPKRES.FCUBSBODY value) {
