...
@XmlRootElement(name = "CLOSETDAMOUNTBLOCK_FSFS_RES")
public class CLOSETDAMOUNTBLOCKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSETDAMOUNTBLOCKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSETDAMOUNTBLOCKFSFSRES.FCUBSBODY }
     *     
     */
    public CLOSETDAMOUNTBLOCKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSETDAMOUNTBLOCKFSFSRES.FCUBSBODY value) {
