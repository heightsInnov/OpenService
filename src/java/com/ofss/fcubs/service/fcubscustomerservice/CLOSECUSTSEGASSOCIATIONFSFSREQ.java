...
@XmlRootElement(name = "CLOSECUSTSEGASSOCIATION_FSFS_REQ")
public class CLOSECUSTSEGASSOCIATIONFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY }
     *     
     */
    public CLOSECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY value) {
