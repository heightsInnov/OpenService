...
@XmlRootElement(name = "CREATECUSTSEGASSOCIATION_FSFS_REQ")
public class CREATECUSTSEGASSOCIATIONFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY }
     *     
     */
    public CREATECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY value) {
