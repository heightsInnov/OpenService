 ...
 *                   &lt;element name="Cust-Seg-Mapping-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustSegAssociation-Modify-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "MODIFYCUSTSEGASSOCIATION_IOPK_RES")
public class MODIFYCUSTSEGASSOCIATIONIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY value) {
