...
@XmlRootElement(name = "CREATETDAMOUNTBLOCK_FSFS_RES")
public class CREATETDAMOUNTBLOCKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATETDAMOUNTBLOCKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATETDAMOUNTBLOCKFSFSRES.FCUBSBODY }
     *     
     */
    public CREATETDAMOUNTBLOCKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATETDAMOUNTBLOCKFSFSRES.FCUBSBODY value) {
