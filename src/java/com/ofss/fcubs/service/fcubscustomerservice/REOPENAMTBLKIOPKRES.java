 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AmtBlk-Reopen-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "REOPENAMTBLK_IOPK_RES")
public class REOPENAMTBLKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENAMTBLKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENAMTBLKIOPKRES.FCUBSBODY }
     *     
     */
    public REOPENAMTBLKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENAMTBLKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected AmtBlkReopenIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link AmtBlkReopenIOType }
         *     
         */
        public AmtBlkReopenIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(AmtBlkReopenIOType value) {
