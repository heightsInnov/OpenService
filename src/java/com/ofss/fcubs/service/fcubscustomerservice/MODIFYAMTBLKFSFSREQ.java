...
@XmlRootElement(name = "MODIFYAMTBLK_FSFS_REQ")
public class MODIFYAMTBLKFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYAMTBLKFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYAMTBLKFSFSREQ.FCUBSBODY }
     *     
     */
    public MODIFYAMTBLKFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYAMTBLKFSFSREQ.FCUBSBODY value) {
