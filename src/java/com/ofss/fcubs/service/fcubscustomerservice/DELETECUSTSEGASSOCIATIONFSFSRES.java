...
@XmlRootElement(name = "DELETECUSTSEGASSOCIATION_FSFS_RES")
public class DELETECUSTSEGASSOCIATIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY }
     *     
     */
    public DELETECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY value) {
