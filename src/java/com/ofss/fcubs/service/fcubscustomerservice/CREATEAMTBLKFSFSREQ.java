...
@XmlRootElement(name = "CREATEAMTBLK_FSFS_REQ")
public class CREATEAMTBLKFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEAMTBLKFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEAMTBLKFSFSREQ.FCUBSBODY }
     *     
     */
    public CREATEAMTBLKFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEAMTBLKFSFSREQ.FCUBSBODY value) {
