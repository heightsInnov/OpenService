...
@XmlRootElement(name = "CREATENSFMUTUAL_FSFS_RES")
public class CREATENSFMUTUALFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATENSFMUTUALFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATENSFMUTUALFSFSRES.FCUBSBODY }
     *     
     */
    public CREATENSFMUTUALFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATENSFMUTUALFSFSRES.FCUBSBODY value) {
