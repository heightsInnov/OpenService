...
@XmlRootElement(name = "AMOUNTBLOCKSREOPEN_FSFS_REQ")
public class AMOUNTBLOCKSREOPENFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSREOPENFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSREOPENFSFSREQ.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSREOPENFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSREOPENFSFSREQ.FCUBSBODY value) {
