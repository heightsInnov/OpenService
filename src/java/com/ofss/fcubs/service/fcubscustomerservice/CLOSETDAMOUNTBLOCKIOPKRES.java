 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}TDAmountBlock-Close-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CLOSETDAMOUNTBLOCK_IOPK_RES")
public class CLOSETDAMOUNTBLOCKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSETDAMOUNTBLOCKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSETDAMOUNTBLOCKIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSETDAMOUNTBLOCKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSETDAMOUNTBLOCKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected TDAmountBlockCloseIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link TDAmountBlockCloseIOType }
         *     
         */
        public TDAmountBlockCloseIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(TDAmountBlockCloseIOType value) {
