...
@XmlRootElement(name = "AMOUNTBLOCKSNEW_FSFS_RES")
public class AMOUNTBLOCKSNEWFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSNEWFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSNEWFSFSRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSNEWFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSNEWFSFSRES.FCUBSBODY value) {
