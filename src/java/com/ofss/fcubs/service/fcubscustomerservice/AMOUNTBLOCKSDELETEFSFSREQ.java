...
@XmlRootElement(name = "AMOUNTBLOCKSDELETE_FSFS_REQ")
public class AMOUNTBLOCKSDELETEFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSDELETEFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSDELETEFSFSREQ.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSDELETEFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSDELETEFSFSREQ.FCUBSBODY value) {
