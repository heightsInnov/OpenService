...
@XmlRootElement(name = "REOPENCUSTOMER_FSFS_RES")
public class REOPENCUSTOMERFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENCUSTOMERFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENCUSTOMERFSFSRES.FCUBSBODY }
     *     
     */
    public REOPENCUSTOMERFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENCUSTOMERFSFSRES.FCUBSBODY value) {
