 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}TDAmountBlock-Delete-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "DELETETDAMOUNTBLOCK_IOPK_RES")
public class DELETETDAMOUNTBLOCKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETETDAMOUNTBLOCKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETETDAMOUNTBLOCKIOPKRES.FCUBSBODY }
     *     
     */
    public DELETETDAMOUNTBLOCKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETETDAMOUNTBLOCKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected TDAmountBlockDeleteIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link TDAmountBlockDeleteIOType }
         *     
         */
        public TDAmountBlockDeleteIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(TDAmountBlockDeleteIOType value) {
