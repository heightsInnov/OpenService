...
/**
 * <p>Java class for Custjoint-Modify-IO-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Custjoint-Modify-IO-Type">
 *   &lt;complexContent>
...
@XmlType(name = "Custjoint-Modify-IO-Type", propOrder = {
    "custno",
    "custjoint"
})
public class CustjointModifyIOType {

    @XmlElement(name = "CUSTNO")
    protected String custno;
    @XmlElement(name = "Custjoint")
    protected List<CustjointModifyIOType.Custjoint> custjoint;
     ...
     * {@link CustjointModifyIOType.Custjoint }
     * 
     * 
     */
    public List<CustjointModifyIOType.Custjoint> getCustjoint() {
        if (custjoint == null) {
            custjoint = new ArrayList<CustjointModifyIOType.Custjoint>();
        }
