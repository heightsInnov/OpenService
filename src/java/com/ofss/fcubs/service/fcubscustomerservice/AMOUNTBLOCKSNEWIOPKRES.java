...
@XmlRootElement(name = "AMOUNTBLOCKSNEW_IOPK_RES")
public class AMOUNTBLOCKSNEWIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSNEWIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSNEWIOPKRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSNEWIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSNEWIOPKRES.FCUBSBODY value) {
