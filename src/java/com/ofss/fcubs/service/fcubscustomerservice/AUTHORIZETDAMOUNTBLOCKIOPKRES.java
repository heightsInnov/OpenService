 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}TDAmountBlock-Authorize-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "AUTHORIZETDAMOUNTBLOCK_IOPK_RES")
public class AUTHORIZETDAMOUNTBLOCKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZETDAMOUNTBLOCKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZETDAMOUNTBLOCKIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZETDAMOUNTBLOCKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZETDAMOUNTBLOCKIOPKRES.FCUBSBODY value) {
