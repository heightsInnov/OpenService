 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Customer-Create-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CREATECUSTOMER_IOPK_RES")
public class CREATECUSTOMERIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATECUSTOMERIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATECUSTOMERIOPKRES.FCUBSBODY }
     *     
     */
    public CREATECUSTOMERIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATECUSTOMERIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CustomerCreateIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link CustomerCreateIOType }
         *     
         */
        public CustomerCreateIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(CustomerCreateIOType value) {
