 ...
 *                   &lt;element name="Cust-Seg-Mapping-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustSegAssociation-Authorize-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "AUTHORIZECUSTSEGASSOCIATION_IOPK_RES")
public class AUTHORIZECUSTSEGASSOCIATIONIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY value) {
