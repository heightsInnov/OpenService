 ...
 *                   &lt;element name="Cust-Seg-Mapping-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustSegAssociation-Close-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CLOSECUSTSEGASSOCIATION_IOPK_RES")
public class CLOSECUSTSEGASSOCIATIONIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSECUSTSEGASSOCIATIONIOPKRES.FCUBSBODY value) {
