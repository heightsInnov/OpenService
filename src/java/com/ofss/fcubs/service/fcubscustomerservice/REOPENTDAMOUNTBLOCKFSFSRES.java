...
@XmlRootElement(name = "REOPENTDAMOUNTBLOCK_FSFS_RES")
public class REOPENTDAMOUNTBLOCKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENTDAMOUNTBLOCKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENTDAMOUNTBLOCKFSFSRES.FCUBSBODY }
     *     
     */
    public REOPENTDAMOUNTBLOCKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENTDAMOUNTBLOCKFSFSRES.FCUBSBODY value) {
