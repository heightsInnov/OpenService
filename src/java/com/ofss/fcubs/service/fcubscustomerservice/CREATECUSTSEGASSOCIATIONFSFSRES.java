...
@XmlRootElement(name = "CREATECUSTSEGASSOCIATION_FSFS_RES")
public class CREATECUSTSEGASSOCIATIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY }
     *     
     */
    public CREATECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATECUSTSEGASSOCIATIONFSFSRES.FCUBSBODY value) {
