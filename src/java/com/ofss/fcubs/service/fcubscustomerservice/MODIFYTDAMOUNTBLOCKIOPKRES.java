 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}TDAmountBlock-Modify-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "MODIFYTDAMOUNTBLOCK_IOPK_RES")
public class MODIFYTDAMOUNTBLOCKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYTDAMOUNTBLOCKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYTDAMOUNTBLOCKIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYTDAMOUNTBLOCKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYTDAMOUNTBLOCKIOPKRES.FCUBSBODY value) {
