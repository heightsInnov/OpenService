...
@XmlRootElement(name = "AUTHORIZECUSTSEGASSOCIATION_FSFS_REQ")
public class AUTHORIZECUSTSEGASSOCIATIONFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY }
     *     
     */
    public AUTHORIZECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY value) {
