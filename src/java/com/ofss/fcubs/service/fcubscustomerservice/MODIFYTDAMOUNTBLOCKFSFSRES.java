...
@XmlRootElement(name = "MODIFYTDAMOUNTBLOCK_FSFS_RES")
public class MODIFYTDAMOUNTBLOCKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYTDAMOUNTBLOCKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYTDAMOUNTBLOCKFSFSRES.FCUBSBODY }
     *     
     */
    public MODIFYTDAMOUNTBLOCKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYTDAMOUNTBLOCKFSFSRES.FCUBSBODY value) {
