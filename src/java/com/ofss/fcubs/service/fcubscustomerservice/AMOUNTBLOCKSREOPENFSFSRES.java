...
@XmlRootElement(name = "AMOUNTBLOCKSREOPEN_FSFS_RES")
public class AMOUNTBLOCKSREOPENFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSREOPENFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSREOPENFSFSRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSREOPENFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSREOPENFSFSRES.FCUBSBODY value) {
