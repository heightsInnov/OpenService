 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Struct-PK" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Structure-PK-Type" minOccurs="0"/>
 *                   &lt;element name="Struct-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Structure-Modify-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "MODIFYACCOUNTSTRUCTURE_IOPK_RES")
public class MODIFYACCOUNTSTRUCTUREIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYACCOUNTSTRUCTUREIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYACCOUNTSTRUCTUREIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYACCOUNTSTRUCTUREIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYACCOUNTSTRUCTUREIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Struct-PK")
        protected StructurePKType structPK;
        @XmlElement(name = "Struct-IO")
        protected StructureModifyIOType structIO;
        ...
        /**
         * Gets the value of the structPK property.
         * 
         * @return
         *     possible object is
         *     {@link StructurePKType }
         *     
         */
        public StructurePKType getStructPK() {
            return structPK;
        }

        /**
         * Sets the value of the structPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link StructurePKType }
         *     
         */
        public void setStructPK(StructurePKType value) {
            this.structPK = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link StructureModifyIOType }
         *     
         */
        public StructureModifyIOType getStructIO() {
            return structIO;
        }
         ...
         *     
         */
        public void setStructIO(StructureModifyIOType value) {
            this.structIO = value;
        }
