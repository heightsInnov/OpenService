 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AmtBlk-Authorize-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "AUTHORIZEAMTBLK_IOPK_RES")
public class AUTHORIZEAMTBLKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZEAMTBLKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZEAMTBLKIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZEAMTBLKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZEAMTBLKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected AmtBlkAuthorizeIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link AmtBlkAuthorizeIOType }
         *     
         */
        public AmtBlkAuthorizeIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(AmtBlkAuthorizeIOType value) {
