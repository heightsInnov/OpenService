...
@XmlRootElement(name = "REOPENCUSTSEGASSOCIATION_FSFS_REQ")
public class REOPENCUSTSEGASSOCIATIONFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENCUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENCUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY }
     *     
     */
    public REOPENCUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENCUSTSEGASSOCIATIONFSFSREQ.FCUBSBODY value) {
