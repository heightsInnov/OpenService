...
@XmlRootElement(name = "AMOUNTBLOCKSCLOSE_FSFS_RES")
public class AMOUNTBLOCKSCLOSEFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSCLOSEFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSCLOSEFSFSRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSCLOSEFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSCLOSEFSFSRES.FCUBSBODY value) {
