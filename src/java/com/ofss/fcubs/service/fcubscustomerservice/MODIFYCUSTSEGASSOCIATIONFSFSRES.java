...
@XmlRootElement(name = "MODIFYCUSTSEGASSOCIATION_FSFS_RES")
public class MODIFYCUSTSEGASSOCIATIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY }
     *     
     */
    public MODIFYCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY value) {
