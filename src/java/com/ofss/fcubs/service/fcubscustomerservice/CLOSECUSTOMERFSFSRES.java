...
@XmlRootElement(name = "CLOSECUSTOMER_FSFS_RES")
public class CLOSECUSTOMERFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSECUSTOMERFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSECUSTOMERFSFSRES.FCUBSBODY }
     *     
     */
    public CLOSECUSTOMERFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSECUSTOMERFSFSRES.FCUBSBODY value) {
