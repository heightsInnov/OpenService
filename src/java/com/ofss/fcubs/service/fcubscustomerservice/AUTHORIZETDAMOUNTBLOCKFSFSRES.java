 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Amount-Blocks-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}TDAmountBlock-Full-Type"/>
...
@XmlRootElement(name = "AUTHORIZETDAMOUNTBLOCK_FSFS_RES")
public class AUTHORIZETDAMOUNTBLOCKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZETDAMOUNTBLOCKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZETDAMOUNTBLOCKFSFSRES.FCUBSBODY }
     *     
     */
    public AUTHORIZETDAMOUNTBLOCKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZETDAMOUNTBLOCKFSFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Amount-Blocks-Full", required = true)
