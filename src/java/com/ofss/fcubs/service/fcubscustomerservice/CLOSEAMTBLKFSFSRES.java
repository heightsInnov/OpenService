...
@XmlRootElement(name = "CLOSEAMTBLK_FSFS_RES")
public class CLOSEAMTBLKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSEAMTBLKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSEAMTBLKFSFSRES.FCUBSBODY }
     *     
     */
    public CLOSEAMTBLKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSEAMTBLKFSFSRES.FCUBSBODY value) {
