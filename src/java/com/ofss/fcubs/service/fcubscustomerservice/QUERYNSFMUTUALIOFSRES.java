 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="MutClr-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Stdnsfms-Query-IO-Type" minOccurs="0"/>
 *                   &lt;element name="MutClr-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Stdnsfms-Full-Type" minOccurs="0"/>
...
@XmlRootElement(name = "QUERYNSFMUTUAL_IOFS_RES")
public class QUERYNSFMUTUALIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYNSFMUTUALIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYNSFMUTUALIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYNSFMUTUALIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYNSFMUTUALIOFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected StdnsfmsQueryIOType mutClrIO;
        @XmlElement(name = "MutClr-Full")
        protected StdnsfmsFullType mutClrFull;
         ...
         * @return
         *     possible object is
         *     {@link StdnsfmsQueryIOType }
         *     
         */
        public StdnsfmsQueryIOType getMutClrIO() {
            return mutClrIO;
        }
         ...
         *     
         */
        public void setMutClrIO(StdnsfmsQueryIOType value) {
            this.mutClrIO = value;
        }

        /**
         * Gets the value of the mutClrFull property.
         * 
         * @return
         *     possible object is
         *     {@link StdnsfmsFullType }
         *     
         */
        public StdnsfmsFullType getMutClrFull() {
            return mutClrFull;
        }

        /**
         * Sets the value of the mutClrFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link StdnsfmsFullType }
         *     
         */
        public void setMutClrFull(StdnsfmsFullType value) {
            this.mutClrFull = value;
        }
