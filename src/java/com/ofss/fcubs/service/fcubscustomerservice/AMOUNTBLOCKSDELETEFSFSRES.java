...
@XmlRootElement(name = "AMOUNTBLOCKSDELETE_FSFS_RES")
public class AMOUNTBLOCKSDELETEFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSDELETEFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSDELETEFSFSRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSDELETEFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSDELETEFSFSRES.FCUBSBODY value) {
