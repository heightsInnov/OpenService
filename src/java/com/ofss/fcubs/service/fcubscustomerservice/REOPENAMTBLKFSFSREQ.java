...
@XmlRootElement(name = "REOPENAMTBLK_FSFS_REQ")
public class REOPENAMTBLKFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENAMTBLKFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENAMTBLKFSFSREQ.FCUBSBODY }
     *     
     */
    public REOPENAMTBLKFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENAMTBLKFSFSREQ.FCUBSBODY value) {
