...
@XmlRootElement(name = "AMOUNTBLOCKSCLOSE_FSFS_REQ")
public class AMOUNTBLOCKSCLOSEFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSCLOSEFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSCLOSEFSFSREQ.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSCLOSEFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSCLOSEFSFSREQ.FCUBSBODY value) {
