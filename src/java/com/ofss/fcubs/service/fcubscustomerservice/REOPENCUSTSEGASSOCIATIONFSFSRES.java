...
@XmlRootElement(name = "REOPENCUSTSEGASSOCIATION_FSFS_RES")
public class REOPENCUSTSEGASSOCIATIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY }
     *     
     */
    public REOPENCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENCUSTSEGASSOCIATIONFSFSRES.FCUBSBODY value) {
