 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AmtBlk-Close-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CLOSEAMTBLK_IOPK_RES")
public class CLOSEAMTBLKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSEAMTBLKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSEAMTBLKIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSEAMTBLKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSEAMTBLKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected AmtBlkCloseIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link AmtBlkCloseIOType }
         *     
         */
        public AmtBlkCloseIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(AmtBlkCloseIOType value) {
