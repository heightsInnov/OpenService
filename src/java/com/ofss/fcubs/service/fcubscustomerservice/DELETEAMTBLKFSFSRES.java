...
@XmlRootElement(name = "DELETEAMTBLK_FSFS_RES")
public class DELETEAMTBLKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETEAMTBLKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETEAMTBLKFSFSRES.FCUBSBODY }
     *     
     */
    public DELETEAMTBLKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETEAMTBLKFSFSRES.FCUBSBODY value) {
