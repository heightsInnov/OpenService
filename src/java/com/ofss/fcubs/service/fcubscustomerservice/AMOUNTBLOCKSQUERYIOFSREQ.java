...
@XmlRootElement(name = "AMOUNTBLOCKSQUERY_IOFS_REQ")
public class AMOUNTBLOCKSQUERYIOFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSQUERYIOFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSQUERYIOFSREQ.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSQUERYIOFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSQUERYIOFSREQ.FCUBSBODY value) {
