...
@XmlRootElement(name = "AMOUNTBLOCKSNEW_FSFS_REQ")
public class AMOUNTBLOCKSNEWFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSNEWFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSNEWFSFSREQ.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSNEWFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSNEWFSFSREQ.FCUBSBODY value) {
