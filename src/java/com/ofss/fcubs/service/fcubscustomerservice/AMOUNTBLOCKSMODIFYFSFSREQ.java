...
@XmlRootElement(name = "AMOUNTBLOCKSMODIFY_FSFS_REQ")
public class AMOUNTBLOCKSMODIFYFSFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSMODIFYFSFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSMODIFYFSFSREQ.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSMODIFYFSFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSMODIFYFSFSREQ.FCUBSBODY value) {
