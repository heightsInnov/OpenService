 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Customer-Close-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CLOSECUSTOMER_IOPK_RES")
public class CLOSECUSTOMERIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSECUSTOMERIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSECUSTOMERIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSECUSTOMERIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSECUSTOMERIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CustomerCloseIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link CustomerCloseIOType }
         *     
         */
        public CustomerCloseIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(CustomerCloseIOType value) {
