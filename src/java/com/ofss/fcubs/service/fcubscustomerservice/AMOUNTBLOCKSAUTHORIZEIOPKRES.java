...
@XmlRootElement(name = "AMOUNTBLOCKSAUTHORIZE_IOPK_RES")
public class AMOUNTBLOCKSAUTHORIZEIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSAUTHORIZEIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSAUTHORIZEIOPKRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSAUTHORIZEIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSAUTHORIZEIOPKRES.FCUBSBODY value) {
