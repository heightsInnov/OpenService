...
@XmlRootElement(name = "CREATECUSTOMER_FSFS_RES")
public class CREATECUSTOMERFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATECUSTOMERFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATECUSTOMERFSFSRES.FCUBSBODY }
     *     
     */
    public CREATECUSTOMERFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATECUSTOMERFSFSRES.FCUBSBODY value) {
