...
public class CusttextCreateIOType {
    ...
    protected List<CusttextCreateIOType.CUSTTEXT> custtext;
     ...
     * {@link CusttextCreateIOType.CUSTTEXT }
     * 
     * 
     */
    public List<CusttextCreateIOType.CUSTTEXT> getCUSTTEXT() {
        if (custtext == null) {
            custtext = new ArrayList<CusttextCreateIOType.CUSTTEXT>();
        }
