...
@XmlRootElement(name = "REOPENAMTBLK_FSFS_RES")
public class REOPENAMTBLKFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENAMTBLKFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENAMTBLKFSFSRES.FCUBSBODY }
     *     
     */
    public REOPENAMTBLKFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENAMTBLKFSFSRES.FCUBSBODY value) {
