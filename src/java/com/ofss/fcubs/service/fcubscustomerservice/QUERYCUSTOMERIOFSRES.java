 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Customer-Query-IO-Type" minOccurs="0"/>
 *                   &lt;element name="Customer-Full" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Customer-Full-Type" minOccurs="0"/>
...
@XmlRootElement(name = "QUERYCUSTOMER_IOFS_RES")
public class QUERYCUSTOMERIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYCUSTOMERIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYCUSTOMERIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYCUSTOMERIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYCUSTOMERIOFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CustomerQueryIOType customerIO;
        @XmlElement(name = "Customer-Full")
        protected CustomerFullType customerFull;
         ...
         * @return
         *     possible object is
         *     {@link CustomerQueryIOType }
         *     
         */
        public CustomerQueryIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(CustomerQueryIOType value) {
            this.customerIO = value;
        }

        /**
         * Gets the value of the customerFull property.
         * 
         * @return
         *     possible object is
         *     {@link CustomerFullType }
         *     
         */
        public CustomerFullType getCustomerFull() {
            return customerFull;
        }

        /**
         * Sets the value of the customerFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustomerFullType }
         *     
         */
        public void setCustomerFull(CustomerFullType value) {
            this.customerFull = value;
        }
