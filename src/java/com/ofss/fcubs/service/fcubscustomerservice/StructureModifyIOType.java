...
public class StructureModifyIOType {
    ...
    protected List<StructureModifyIOType.StructDetail> structDetail;
     ...
     * {@link StructureModifyIOType.StructDetail }
     * 
     * 
     */
    public List<StructureModifyIOType.StructDetail> getStructDetail() {
        if (structDetail == null) {
            structDetail = new ArrayList<StructureModifyIOType.StructDetail>();
        }
