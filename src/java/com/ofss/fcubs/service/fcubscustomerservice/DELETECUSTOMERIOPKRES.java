 ...
 *                   &lt;element name="Customer-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}Customer-Delete-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "DELETECUSTOMER_IOPK_RES")
public class DELETECUSTOMERIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETECUSTOMERIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETECUSTOMERIOPKRES.FCUBSBODY }
     *     
     */
    public DELETECUSTOMERIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETECUSTOMERIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected CustomerDeleteIOType customerIO;
         ...
         * @return
         *     possible object is
         *     {@link CustomerDeleteIOType }
         *     
         */
        public CustomerDeleteIOType getCustomerIO() {
            return customerIO;
        }
         ...
         *     
         */
        public void setCustomerIO(CustomerDeleteIOType value) {
