...
/**
 * <p>Java class for CustDiaryDetails-Full-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CustDiaryDetails-Full-Type">
 *   &lt;complexContent>
...
@XmlType(name = "CustDiaryDetails-Full-Type", propOrder = {
    "custno",
    "diaryMst"
})
public class CustDiaryDetailsFullType {

    @XmlElement(name = "CUSTNO")
    protected String custno;
    @XmlElement(name = "Diary-Mst")
    protected List<CustDiaryDetailsFullType.DiaryMst> diaryMst;
     ...
     * {@link CustDiaryDetailsFullType.DiaryMst }
     * 
     * 
     */
    public List<CustDiaryDetailsFullType.DiaryMst> getDiaryMst() {
        if (diaryMst == null) {
            diaryMst = new ArrayList<CustDiaryDetailsFullType.DiaryMst>();
        }
