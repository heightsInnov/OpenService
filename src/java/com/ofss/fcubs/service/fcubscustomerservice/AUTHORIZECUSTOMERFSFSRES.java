...
@XmlRootElement(name = "AUTHORIZECUSTOMER_FSFS_RES")
public class AUTHORIZECUSTOMERFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZECUSTOMERFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZECUSTOMERFSFSRES.FCUBSBODY }
     *     
     */
    public AUTHORIZECUSTOMERFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZECUSTOMERFSFSRES.FCUBSBODY value) {
