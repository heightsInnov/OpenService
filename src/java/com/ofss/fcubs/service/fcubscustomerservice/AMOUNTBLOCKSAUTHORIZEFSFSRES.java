...
@XmlRootElement(name = "AMOUNTBLOCKSAUTHORIZE_FSFS_RES")
public class AMOUNTBLOCKSAUTHORIZEFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AMOUNTBLOCKSAUTHORIZEFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AMOUNTBLOCKSAUTHORIZEFSFSRES.FCUBSBODY }
     *     
     */
    public AMOUNTBLOCKSAUTHORIZEFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AMOUNTBLOCKSAUTHORIZEFSFSRES.FCUBSBODY value) {
