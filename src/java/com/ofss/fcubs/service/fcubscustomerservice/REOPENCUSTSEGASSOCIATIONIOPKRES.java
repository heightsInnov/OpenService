 ...
 *                   &lt;element name="Cust-Seg-Mapping-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}CustSegAssociation-Reopen-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "REOPENCUSTSEGASSOCIATION_IOPK_RES")
public class REOPENCUSTSEGASSOCIATIONIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY }
     *     
     */
    public REOPENCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENCUSTSEGASSOCIATIONIOPKRES.FCUBSBODY value) {
