...
/**
 * <p>Java class for CustDiaryDetails-Create-IO-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CustDiaryDetails-Create-IO-Type">
 *   &lt;complexContent>
...
@XmlType(name = "CustDiaryDetails-Create-IO-Type", propOrder = {
    "custno",
    "diaryMst"
})
public class CustDiaryDetailsCreateIOType {

    @XmlElement(name = "CUSTNO")
    protected String custno;
    @XmlElement(name = "Diary-Mst")
    protected List<CustDiaryDetailsCreateIOType.DiaryMst> diaryMst;
     ...
     * {@link CustDiaryDetailsCreateIOType.DiaryMst }
     * 
     * 
     */
    public List<CustDiaryDetailsCreateIOType.DiaryMst> getDiaryMst() {
        if (diaryMst == null) {
            diaryMst = new ArrayList<CustDiaryDetailsCreateIOType.DiaryMst>();
        }
