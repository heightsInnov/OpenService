 ...
 *                   &lt;element name="Amount-Blocks-IO" type="{http://fcubs.ofss.com/service/FCUBSCustomerService}AmtBlk-Modify-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "MODIFYAMTBLK_IOPK_RES")
public class MODIFYAMTBLKIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYAMTBLKIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYAMTBLKIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYAMTBLKIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYAMTBLKIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected AmtBlkModifyIOType amountBlocksIO;
         ...
         * @return
         *     possible object is
         *     {@link AmtBlkModifyIOType }
         *     
         */
        public AmtBlkModifyIOType getAmountBlocksIO() {
         ...
         *     
         */
        public void setAmountBlocksIO(AmtBlkModifyIOType value) {
