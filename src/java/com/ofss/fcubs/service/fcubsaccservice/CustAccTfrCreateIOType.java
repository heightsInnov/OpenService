...
public class CustAccTfrCreateIOType {
    ...
    public static class IctmAcc {
        ...
        protected List<CustAccTfrCreateIOType.IctmAcc.Interest> interest;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link CustAccTfrCreateIOType.IctmAcc.Interest }
         * 
         * 
         */
        public List<CustAccTfrCreateIOType.IctmAcc.Interest> getInterest() {
            if (interest == null) {
                interest = new ArrayList<CustAccTfrCreateIOType.IctmAcc.Interest>();
            }
        ...
        public static class Interest {
            ...
            protected List<CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt> udeEffdt;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt }
             * 
             * 
             */
            public List<CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt> getUdeEffdt() {
                if (udeEffdt == null) {
                    udeEffdt = new ArrayList<CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt>();
                }
            ...
            public static class UdeEffdt {
                ...
                protected List<CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt.UdeVals> udeVals;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt.UdeVals }
                 * 
                 * 
                 */
                public List<CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt.UdeVals> getUdeVals() {
                    if (udeVals == null) {
                        udeVals = new ArrayList<CustAccTfrCreateIOType.IctmAcc.Interest.UdeEffdt.UdeVals>();
                    }
                    return this.udeVals;
                }
