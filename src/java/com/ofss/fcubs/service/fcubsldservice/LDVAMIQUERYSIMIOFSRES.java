 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="LDvws-Contract-master" type="{http://fcubs.ofss.com/service/FCUBSLDService}LoansandDeposits-Full-Type"/>
...
@XmlRootElement(name = "LDVAMIQUERYSIM_IOFS_RES")
public class LDVAMIQUERYSIMIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected LDVAMIQUERYSIMIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link LDVAMIQUERYSIMIOFSRES.FCUBSBODY }
     *     
     */
    public LDVAMIQUERYSIMIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(LDVAMIQUERYSIMIOFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "LDvws-Contract-master", required = true)
        protected LoansandDepositsFullType lDvwsContractMaster;
        ...
        /**
         * Gets the value of the lDvwsContractMaster property.
         * 
         * @return
         *     possible object is
         *     {@link LoansandDepositsFullType }
         *     
         */
        public LoansandDepositsFullType getLDvwsContractMaster() {
            return lDvwsContractMaster;
        }

        /**
         * Sets the value of the lDvwsContractMaster property.
         * 
         * @param value
         *     allowed object is
         *     {@link LoansandDepositsFullType }
         *     
         */
        public void setLDvwsContractMaster(LoansandDepositsFullType value) {
            this.lDvwsContractMaster = value;
        }
