...
/**
 * <p>Java class for ProductCharges-Create-IO-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProductCharges-Create-IO-Type">
 *   &lt;complexContent>
...
@XmlType(name = "ProductCharges-Create-IO-Type", propOrder = {
    "chargeDetails"
})
public class ProductChargesCreateIOType {

    @XmlElement(name = "Charge-Details")
    protected List<ProductChargesCreateIOType.ChargeDetails> chargeDetails;
     ...
     * {@link ProductChargesCreateIOType.ChargeDetails }
     * 
     * 
     */
    public List<ProductChargesCreateIOType.ChargeDetails> getChargeDetails() {
        if (chargeDetails == null) {
            chargeDetails = new ArrayList<ProductChargesCreateIOType.ChargeDetails>();
        }
