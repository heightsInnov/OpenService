...
@XmlRootElement(name = "QUERYPROVISIONLDCONTRACT_IOFS_RES")
public class QUERYPROVISIONLDCONTRACTIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYPROVISIONLDCONTRACTIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYPROVISIONLDCONTRACTIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYPROVISIONLDCONTRACTIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYPROVISIONLDCONTRACTIOFSRES.FCUBSBODY value) {
