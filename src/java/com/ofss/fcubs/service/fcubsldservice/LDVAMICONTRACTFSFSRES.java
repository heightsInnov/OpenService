...
@XmlRootElement(name = "LDVAMICONTRACT_FSFS_RES")
public class LDVAMICONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected LDVAMICONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link LDVAMICONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public LDVAMICONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(LDVAMICONTRACTFSFSRES.FCUBSBODY value) {
