...
@XmlRootElement(name = "DELETELDCONTRACT_FSFS_RES")
public class DELETELDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETELDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETELDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public DELETELDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETELDCONTRACTFSFSRES.FCUBSBODY value) {
