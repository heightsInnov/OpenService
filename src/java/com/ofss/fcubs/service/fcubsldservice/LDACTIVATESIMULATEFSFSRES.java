...
@XmlRootElement(name = "LDACTIVATESIMULATE_FSFS_RES")
public class LDACTIVATESIMULATEFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected LDACTIVATESIMULATEFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link LDACTIVATESIMULATEFSFSRES.FCUBSBODY }
     *     
     */
    public LDACTIVATESIMULATEFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(LDACTIVATESIMULATEFSFSRES.FCUBSBODY value) {
