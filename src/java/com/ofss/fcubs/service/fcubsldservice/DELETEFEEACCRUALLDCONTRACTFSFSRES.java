...
@XmlRootElement(name = "DELETEFEEACCRUALLDCONTRACT_FSFS_RES")
public class DELETEFEEACCRUALLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public DELETEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY value) {
