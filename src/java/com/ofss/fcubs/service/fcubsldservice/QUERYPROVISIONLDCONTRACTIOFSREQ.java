...
@XmlRootElement(name = "QUERYPROVISIONLDCONTRACT_IOFS_REQ")
public class QUERYPROVISIONLDCONTRACTIOFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYPROVISIONLDCONTRACTIOFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYPROVISIONLDCONTRACTIOFSREQ.FCUBSBODY }
     *     
     */
    public QUERYPROVISIONLDCONTRACTIOFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYPROVISIONLDCONTRACTIOFSREQ.FCUBSBODY value) {
