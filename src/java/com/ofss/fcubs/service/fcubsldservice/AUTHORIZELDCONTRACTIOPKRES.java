 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Auth-Details-PK" type="{http://fcubs.ofss.com/service/FCUBSLDService}Auth-LD-RES-PK-Type" minOccurs="0"/>
 *                   &lt;element name="Auth-Details" type="{http://fcubs.ofss.com/service/FCUBSLDService}Auth-Details-IOType" minOccurs="0"/>
...
@XmlRootElement(name = "AUTHORIZELDCONTRACT_IOPK_RES")
public class AUTHORIZELDCONTRACTIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZELDCONTRACTIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZELDCONTRACTIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZELDCONTRACTIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZELDCONTRACTIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Auth-Details-PK")
        protected AuthLDRESPKType authDetailsPK;
        @XmlElement(name = "Auth-Details")
        protected AuthDetailsIOType authDetails;
        ...
        /**
         * Gets the value of the authDetailsPK property.
         * 
         * @return
         *     possible object is
         *     {@link AuthLDRESPKType }
         *     
         */
        public AuthLDRESPKType getAuthDetailsPK() {
            return authDetailsPK;
        }

        /**
         * Sets the value of the authDetailsPK property.
         * 
         * @param value
         *     allowed object is
         *     {@link AuthLDRESPKType }
         *     
         */
        public void setAuthDetailsPK(AuthLDRESPKType value) {
            this.authDetailsPK = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link AuthDetailsIOType }
         *     
         */
        public AuthDetailsIOType getAuthDetails() {
            return authDetails;
        }
         ...
         *     
         */
        public void setAuthDetails(AuthDetailsIOType value) {
