...
/**
 * <p>Java class for ProdAccrualFee-Modify-IO-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProdAccrualFee-Modify-IO-Type">
 *   &lt;complexContent>
...
@XmlType(name = "ProdAccrualFee-Modify-IO-Type", propOrder = {
    "accrualFeeDetails"
})
public class ProdAccrualFeeModifyIOType {

    @XmlElement(name = "Accrual-Fee-Details")
    protected List<ProdAccrualFeeModifyIOType.AccrualFeeDetails> accrualFeeDetails;
     ...
     * {@link ProdAccrualFeeModifyIOType.AccrualFeeDetails }
     * 
     * 
     */
    public List<ProdAccrualFeeModifyIOType.AccrualFeeDetails> getAccrualFeeDetails() {
        if (accrualFeeDetails == null) {
            accrualFeeDetails = new ArrayList<ProdAccrualFeeModifyIOType.AccrualFeeDetails>();
        }
