...
@XmlRootElement(name = "CREATELDPAYMENT_FSFS_RES")
public class CREATELDPAYMENTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATELDPAYMENTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATELDPAYMENTFSFSRES.FCUBSBODY }
     *     
     */
    public CREATELDPAYMENTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATELDPAYMENTFSFSRES.FCUBSBODY value) {
