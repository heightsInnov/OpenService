...
@XmlRootElement(name = "REVERSELDPAYMENT_FSFS_RES")
public class REVERSELDPAYMENTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REVERSELDPAYMENTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REVERSELDPAYMENTFSFSRES.FCUBSBODY }
     *     
     */
    public REVERSELDPAYMENTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REVERSELDPAYMENTFSFSRES.FCUBSBODY value) {
