...
@XmlRootElement(name = "CREATEFEEACCRUALLDCONTRACT_FSFS_RES")
public class CREATEFEEACCRUALLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public CREATEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY value) {
