...
@XmlRootElement(name = "REVERSELDCONTRACT_FSFS_RES")
public class REVERSELDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REVERSELDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REVERSELDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public REVERSELDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REVERSELDCONTRACTFSFSRES.FCUBSBODY value) {
