...
@XmlRootElement(name = "CREATEPROVISIONLDCONTRACT_IOPK_REQ")
public class CREATEPROVISIONLDCONTRACTIOPKREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEPROVISIONLDCONTRACTIOPKREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEPROVISIONLDCONTRACTIOPKREQ.FCUBSBODY }
     *     
     */
    public CREATEPROVISIONLDCONTRACTIOPKREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEPROVISIONLDCONTRACTIOPKREQ.FCUBSBODY value) {
