...
@XmlRootElement(name = "DELETEBRNPRM_FSFS_RES")
public class DELETEBRNPRMFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETEBRNPRMFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETEBRNPRMFSFSRES.FCUBSBODY }
     *     
     */
    public DELETEBRNPRMFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETEBRNPRMFSFSRES.FCUBSBODY value) {
