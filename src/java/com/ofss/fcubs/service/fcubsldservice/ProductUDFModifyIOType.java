...
public class ProductUDFModifyIOType {
    ...
    protected List<ProductUDFModifyIOType.FieldDetails> fieldDetails;
     ...
     * {@link ProductUDFModifyIOType.FieldDetails }
     * 
     * 
     */
    public List<ProductUDFModifyIOType.FieldDetails> getFieldDetails() {
        if (fieldDetails == null) {
            fieldDetails = new ArrayList<ProductUDFModifyIOType.FieldDetails>();
        }
