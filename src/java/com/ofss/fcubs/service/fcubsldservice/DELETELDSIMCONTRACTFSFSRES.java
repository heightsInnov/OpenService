...
@XmlRootElement(name = "DELETELDSIMCONTRACT_FSFS_RES")
public class DELETELDSIMCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETELDSIMCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETELDSIMCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public DELETELDSIMCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETELDSIMCONTRACTFSFSRES.FCUBSBODY value) {
