...
@XmlRootElement(name = "REVERSEFEEACCRUALLDCONTRACT_FSFS_RES")
public class REVERSEFEEACCRUALLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REVERSEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REVERSEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public REVERSEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REVERSEFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY value) {
