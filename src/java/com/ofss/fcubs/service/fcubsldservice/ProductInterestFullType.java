...
/**
 * <p>Java class for ProductInterest-Full-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProductInterest-Full-Type">
 *   &lt;complexContent>
...
@XmlType(name = "ProductInterest-Full-Type", propOrder = {
    "interestComponents"
})
public class ProductInterestFullType {

    @XmlElement(name = "Interest-Components")
    protected List<ProductInterestFullType.InterestComponents> interestComponents;
     ...
     * {@link ProductInterestFullType.InterestComponents }
     * 
     * 
     */
    public List<ProductInterestFullType.InterestComponents> getInterestComponents() {
        if (interestComponents == null) {
            interestComponents = new ArrayList<ProductInterestFullType.InterestComponents>();
        }
    ...
    public static class InterestComponents {
        ...
        protected List<ProductInterestFullType.InterestComponents.InterestCcyPreferences> interestCcyPreferences;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ProductInterestFullType.InterestComponents.InterestCcyPreferences }
         * 
         * 
         */
        public List<ProductInterestFullType.InterestComponents.InterestCcyPreferences> getInterestCcyPreferences() {
            if (interestCcyPreferences == null) {
                interestCcyPreferences = new ArrayList<ProductInterestFullType.InterestComponents.InterestCcyPreferences>();
            }
