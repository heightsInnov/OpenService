 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Contract-Master" type="{http://fcubs.ofss.com/service/FCUBSLDService}LoansandDeposits-Full-Type"/>
...
@XmlRootElement(name = "LDINACTIVATESIMULATE_FSFS_RES")
public class LDINACTIVATESIMULATEFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected LDINACTIVATESIMULATEFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link LDINACTIVATESIMULATEFSFSRES.FCUBSBODY }
     *     
     */
    public LDINACTIVATESIMULATEFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(LDINACTIVATESIMULATEFSFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Contract-Master", required = true)
        protected LoansandDepositsFullType contractMaster;
         ...
         *     
         */
        public LoansandDepositsFullType getContractMaster() {
         ...
         *     
         */
        public void setContractMaster(LoansandDepositsFullType value) {
