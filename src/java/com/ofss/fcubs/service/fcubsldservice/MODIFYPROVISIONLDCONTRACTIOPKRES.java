...
@XmlRootElement(name = "MODIFYPROVISIONLDCONTRACT_IOPK_RES")
public class MODIFYPROVISIONLDCONTRACTIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYPROVISIONLDCONTRACTIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYPROVISIONLDCONTRACTIOPKRES.FCUBSBODY }
     *     
     */
    public MODIFYPROVISIONLDCONTRACTIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYPROVISIONLDCONTRACTIOPKRES.FCUBSBODY value) {
