...
public class ProdEventDtlsCreateIOType {
    ...
    protected List<ProdEventDtlsCreateIOType.EventDetails> eventDetails;
     ...
     * {@link ProdEventDtlsCreateIOType.EventDetails }
     * 
     * 
     */
    public List<ProdEventDtlsCreateIOType.EventDetails> getEventDetails() {
        if (eventDetails == null) {
            eventDetails = new ArrayList<ProdEventDtlsCreateIOType.EventDetails>();
        }
    ...
    public static class EventDetails {
        ...
        protected List<ProdEventDtlsCreateIOType.EventDetails.AccountingEntries> accountingEntries;
        @XmlElement(name = "Advices")
        protected List<ProdEventDtlsCreateIOType.EventDetails.Advices> advices;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ProdEventDtlsCreateIOType.EventDetails.AccountingEntries }
         * 
         * 
         */
        public List<ProdEventDtlsCreateIOType.EventDetails.AccountingEntries> getAccountingEntries() {
            if (accountingEntries == null) {
                accountingEntries = new ArrayList<ProdEventDtlsCreateIOType.EventDetails.AccountingEntries>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ProdEventDtlsCreateIOType.EventDetails.Advices }
         * 
         * 
         */
        public List<ProdEventDtlsCreateIOType.EventDetails.Advices> getAdvices() {
            if (advices == null) {
                advices = new ArrayList<ProdEventDtlsCreateIOType.EventDetails.Advices>();
            }
            return this.advices;
        }
