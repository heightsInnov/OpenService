...
@XmlRootElement(name = "QUERYLDCONTRACT_IOFS_RES")
public class QUERYLDCONTRACTIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYLDCONTRACTIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYLDCONTRACTIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYLDCONTRACTIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYLDCONTRACTIOFSRES.FCUBSBODY value) {
