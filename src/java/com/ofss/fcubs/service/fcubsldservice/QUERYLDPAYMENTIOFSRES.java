...
@XmlRootElement(name = "QUERYLDPAYMENT_IOFS_RES")
public class QUERYLDPAYMENTIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYLDPAYMENTIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYLDPAYMENTIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYLDPAYMENTIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYLDPAYMENTIOFSRES.FCUBSBODY value) {
