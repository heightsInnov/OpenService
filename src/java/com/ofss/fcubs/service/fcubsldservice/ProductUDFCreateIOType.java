...
public class ProductUDFCreateIOType {
    ...
    protected List<ProductUDFCreateIOType.FieldDetails> fieldDetails;
     ...
     * {@link ProductUDFCreateIOType.FieldDetails }
     * 
     * 
     */
    public List<ProductUDFCreateIOType.FieldDetails> getFieldDetails() {
        if (fieldDetails == null) {
            fieldDetails = new ArrayList<ProductUDFCreateIOType.FieldDetails>();
        }
