...
@XmlRootElement(name = "CREATELDPAYMENTSIM_FSFS_RES")
public class CREATELDPAYMENTSIMFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATELDPAYMENTSIMFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATELDPAYMENTSIMFSFSRES.FCUBSBODY }
     *     
     */
    public CREATELDPAYMENTSIMFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATELDPAYMENTSIMFSFSRES.FCUBSBODY value) {
