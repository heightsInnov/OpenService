...
@XmlRootElement(name = "CREATEPROVISIONLDCONTRACT_FSFS_RES")
public class CREATEPROVISIONLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEPROVISIONLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEPROVISIONLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public CREATEPROVISIONLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEPROVISIONLDCONTRACTFSFSRES.FCUBSBODY value) {
