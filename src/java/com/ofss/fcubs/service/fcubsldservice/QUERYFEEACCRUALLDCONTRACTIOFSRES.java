...
@XmlRootElement(name = "QUERYFEEACCRUALLDCONTRACT_IOFS_RES")
public class QUERYFEEACCRUALLDCONTRACTIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYFEEACCRUALLDCONTRACTIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYFEEACCRUALLDCONTRACTIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYFEEACCRUALLDCONTRACTIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYFEEACCRUALLDCONTRACTIOFSRES.FCUBSBODY value) {
