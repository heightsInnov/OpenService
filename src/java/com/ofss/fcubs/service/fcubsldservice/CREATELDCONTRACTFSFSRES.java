...
@XmlRootElement(name = "CREATELDCONTRACT_FSFS_RES")
public class CREATELDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATELDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATELDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public CREATELDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATELDCONTRACTFSFSRES.FCUBSBODY value) {
