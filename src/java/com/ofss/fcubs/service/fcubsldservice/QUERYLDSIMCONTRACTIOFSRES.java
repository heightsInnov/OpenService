...
@XmlRootElement(name = "QUERYLDSIMCONTRACT_IOFS_RES")
public class QUERYLDSIMCONTRACTIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYLDSIMCONTRACTIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYLDSIMCONTRACTIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYLDSIMCONTRACTIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYLDSIMCONTRACTIOFSRES.FCUBSBODY value) {
