...
@XmlRootElement(name = "AUTHFEEACCRUALLDCONTRACT_FSFS_RES")
public class AUTHFEEACCRUALLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public AUTHFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY value) {
