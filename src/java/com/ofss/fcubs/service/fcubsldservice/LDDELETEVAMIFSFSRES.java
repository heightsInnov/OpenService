...
@XmlRootElement(name = "LDDELETEVAMI_FSFS_RES")
public class LDDELETEVAMIFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected LDDELETEVAMIFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link LDDELETEVAMIFSFSRES.FCUBSBODY }
     *     
     */
    public LDDELETEVAMIFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(LDDELETEVAMIFSFSRES.FCUBSBODY value) {
