...
@XmlRootElement(name = "MODIFYFEEACCRUALLDCONTRACT_FSFS_RES")
public class MODIFYFEEACCRUALLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public MODIFYFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYFEEACCRUALLDCONTRACTFSFSRES.FCUBSBODY value) {
