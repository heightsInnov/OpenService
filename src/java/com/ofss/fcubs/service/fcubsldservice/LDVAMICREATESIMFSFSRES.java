...
@XmlRootElement(name = "LDVAMICREATESIM_FSFS_RES")
public class LDVAMICREATESIMFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected LDVAMICREATESIMFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link LDVAMICREATESIMFSFSRES.FCUBSBODY }
     *     
     */
    public LDVAMICREATESIMFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(LDVAMICREATESIMFSFSRES.FCUBSBODY value) {
