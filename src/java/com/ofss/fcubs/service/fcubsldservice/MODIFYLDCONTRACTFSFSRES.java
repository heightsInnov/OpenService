...
@XmlRootElement(name = "MODIFYLDCONTRACT_FSFS_RES")
public class MODIFYLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public MODIFYLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYLDCONTRACTFSFSRES.FCUBSBODY value) {
