...
@XmlRootElement(name = "MODIFYBRNPRM_FSFS_RES")
public class MODIFYBRNPRMFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected MODIFYBRNPRMFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link MODIFYBRNPRMFSFSRES.FCUBSBODY }
     *     
     */
    public MODIFYBRNPRMFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(MODIFYBRNPRMFSFSRES.FCUBSBODY value) {
