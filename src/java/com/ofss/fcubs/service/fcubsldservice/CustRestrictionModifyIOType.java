...
public class CustRestrictionModifyIOType {
    ...
    protected List<CustRestrictionModifyIOType.CustCategories> custCategories;
    @XmlElement(name = "Customers")
    protected List<CustRestrictionModifyIOType.Customers> customers;
     ...
     * {@link CustRestrictionModifyIOType.CustCategories }
     * 
     * 
     */
    public List<CustRestrictionModifyIOType.CustCategories> getCustCategories() {
        if (custCategories == null) {
            custCategories = new ArrayList<CustRestrictionModifyIOType.CustCategories>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CustRestrictionModifyIOType.Customers }
     * 
     * 
     */
    public List<CustRestrictionModifyIOType.Customers> getCustomers() {
        if (customers == null) {
            customers = new ArrayList<CustRestrictionModifyIOType.Customers>();
        }
