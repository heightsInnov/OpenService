...
@XmlRootElement(name = "CREATEBRNPRM_FSFS_RES")
public class CREATEBRNPRMFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEBRNPRMFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEBRNPRMFSFSRES.FCUBSBODY }
     *     
     */
    public CREATEBRNPRMFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEBRNPRMFSFSRES.FCUBSBODY value) {
