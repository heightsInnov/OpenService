...
@XmlRootElement(name = "AUTHPROVISIONLDCONTRACT_FSFS_RES")
public class AUTHPROVISIONLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHPROVISIONLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHPROVISIONLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public AUTHPROVISIONLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHPROVISIONLDCONTRACTFSFSRES.FCUBSBODY value) {
