...
@XmlRootElement(name = "QUERYLDPAYMENTSIM_IOFS_REQ")
public class QUERYLDPAYMENTSIMIOFSREQ {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYLDPAYMENTSIMIOFSREQ.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYLDPAYMENTSIMIOFSREQ.FCUBSBODY }
     *     
     */
    public QUERYLDPAYMENTSIMIOFSREQ.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYLDPAYMENTSIMIOFSREQ.FCUBSBODY value) {
