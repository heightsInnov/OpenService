...
public class BranchRestrictionCreateIOType {
    ...
    protected List<BranchRestrictionCreateIOType.BranchList> branchList;
    @XmlElement(name = "Ccy-List")
    protected List<BranchRestrictionCreateIOType.CcyList> ccyList;
     ...
     * {@link BranchRestrictionCreateIOType.BranchList }
     * 
     * 
     */
    public List<BranchRestrictionCreateIOType.BranchList> getBranchList() {
        if (branchList == null) {
            branchList = new ArrayList<BranchRestrictionCreateIOType.BranchList>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BranchRestrictionCreateIOType.CcyList }
     * 
     * 
     */
    public List<BranchRestrictionCreateIOType.CcyList> getCcyList() {
        if (ccyList == null) {
            ccyList = new ArrayList<BranchRestrictionCreateIOType.CcyList>();
        }
        return this.ccyList;
    }
