...
@XmlRootElement(name = "ROLLOVERLDCONTRACT_FSFS_RES")
public class ROLLOVERLDCONTRACTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected ROLLOVERLDCONTRACTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link ROLLOVERLDCONTRACTFSFSRES.FCUBSBODY }
     *     
     */
    public ROLLOVERLDCONTRACTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(ROLLOVERLDCONTRACTFSFSRES.FCUBSBODY value) {
