...
public class ProdMisDetailsCreateIOType {
    ...
    protected List<ProdMisDetailsCreateIOType.DefaultMisCodes> defaultMisCodes;
     ...
     * {@link ProdMisDetailsCreateIOType.DefaultMisCodes }
     * 
     * 
     */
    public List<ProdMisDetailsCreateIOType.DefaultMisCodes> getDefaultMisCodes() {
        if (defaultMisCodes == null) {
            defaultMisCodes = new ArrayList<ProdMisDetailsCreateIOType.DefaultMisCodes>();
        }
