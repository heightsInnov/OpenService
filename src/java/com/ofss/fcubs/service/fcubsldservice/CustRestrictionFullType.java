...
public class CustRestrictionFullType {
    ...
    protected List<CustRestrictionFullType.CustCategories> custCategories;
    @XmlElement(name = "Customers")
    protected List<CustRestrictionFullType.Customers> customers;
     ...
     * {@link CustRestrictionFullType.CustCategories }
     * 
     * 
     */
    public List<CustRestrictionFullType.CustCategories> getCustCategories() {
        if (custCategories == null) {
            custCategories = new ArrayList<CustRestrictionFullType.CustCategories>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CustRestrictionFullType.Customers }
     * 
     * 
     */
    public List<CustRestrictionFullType.Customers> getCustomers() {
        if (customers == null) {
            customers = new ArrayList<CustRestrictionFullType.Customers>();
        }
