...
@XmlRootElement(name = "DELETELDPAYMENT_FSFS_RES")
public class DELETELDPAYMENTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected DELETELDPAYMENTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link DELETELDPAYMENTFSFSRES.FCUBSBODY }
     *     
     */
    public DELETELDPAYMENTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(DELETELDPAYMENTFSFSRES.FCUBSBODY value) {
