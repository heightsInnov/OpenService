...
@XmlRootElement(name = "LDVAMIDELETESIM_FSFS_RES")
public class LDVAMIDELETESIMFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected LDVAMIDELETESIMFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link LDVAMIDELETESIMFSFSRES.FCUBSBODY }
     *     
     */
    public LDVAMIDELETESIMFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(LDVAMIDELETESIMFSFSRES.FCUBSBODY value) {
