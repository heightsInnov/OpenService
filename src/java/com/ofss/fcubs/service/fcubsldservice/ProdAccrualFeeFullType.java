...
/**
 * <p>Java class for ProdAccrualFee-Full-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProdAccrualFee-Full-Type">
 *   &lt;complexContent>
...
@XmlType(name = "ProdAccrualFee-Full-Type", propOrder = {
    "accrualFeeDetails"
})
public class ProdAccrualFeeFullType {

    @XmlElement(name = "Accrual-Fee-Details")
    protected List<ProdAccrualFeeFullType.AccrualFeeDetails> accrualFeeDetails;
     ...
     * {@link ProdAccrualFeeFullType.AccrualFeeDetails }
     * 
     * 
     */
    public List<ProdAccrualFeeFullType.AccrualFeeDetails> getAccrualFeeDetails() {
        if (accrualFeeDetails == null) {
            accrualFeeDetails = new ArrayList<ProdAccrualFeeFullType.AccrualFeeDetails>();
        }
