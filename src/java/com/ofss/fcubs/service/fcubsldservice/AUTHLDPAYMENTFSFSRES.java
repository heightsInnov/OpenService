 ...
 *         &lt;element name="FCUBS_BODY" type="{http://fcubs.ofss.com/service/FCUBSLDService}FCUBSPymtAuthType"/>
...
@XmlRootElement(name = "AUTHLDPAYMENT_FSFS_RES")
public class AUTHLDPAYMENTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected FCUBSPymtAuthType fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link FCUBSPymtAuthType }
     *     
     */
    public FCUBSPymtAuthType getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(FCUBSPymtAuthType value) {
