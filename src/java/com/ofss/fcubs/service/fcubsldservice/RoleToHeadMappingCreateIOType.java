...
public class RoleToHeadMappingCreateIOType {
    ...
    protected List<RoleToHeadMappingCreateIOType.MappingDetails> mappingDetails;
     ...
     * {@link RoleToHeadMappingCreateIOType.MappingDetails }
     * 
     * 
     */
    public List<RoleToHeadMappingCreateIOType.MappingDetails> getMappingDetails() {
        if (mappingDetails == null) {
            mappingDetails = new ArrayList<RoleToHeadMappingCreateIOType.MappingDetails>();
        }
